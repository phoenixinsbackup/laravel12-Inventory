                    ...
                    <form action="{{route('profile.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="form-group mb-3 row">
                                ...
                                <div class="col-lg-12 col-xl-12">
                                    <textarea class="form-control" name="address" placeholder="Input your Address">{{$profileData->address}}</textarea>
                                </div>
                            </div>
        ...
        <div class="card-body mb-0">
            ...
            <div class="form-group mb-3 row">
                <label class="form-label">Confirm Password</label>
                    <div class="col-lg-12 col-xl-12">
                    <input class="form-control " name="new_password_confirmation" id="new_password_confirmation" type="password" placeholder="New Password Confirmation">
